...
SMOKE_WINDOW_INTERACTION_PROFILE := ./scripts/smoke/smoke_window_interaction_profile.sh
...
SMOKE_BUILD_ENV = BUILD_DIR=$(BUILD_DIR) CMAKE=$(CMAKE) GENERATOR=$(GENERATOR) TOOLCHAIN_FILE=$(TOOLCHAIN_FILE) GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)
...
TERMINAL_WINDOW_INTERACTION ?= OFF
DESKTOP_BAR_DEBUG_ACTIONS ?= OFF
DESKTOP_DEBUG_DUMMY_APP ?= OFF
DISPLAY_PROFILING ?= OFF
DISPLAY_PROFILE_SCRIPT ?= OFF
DISPLAY_PROFILE_LOG ?= $(BUILD_DIR)/logs/display-profile.log
WINDOW_INTERACTION_PROFILE ?= OFF
WINDOW_INTERACTION_PROFILE_LOG ?= $(BUILD_DIR)/logs/window-interaction-profile.log
...
.PHONY: help deps demo gui profile-gui profile-window-interaction profile-summary test demo-exception test-exception demo-timer test-timer test-paging test-heap test-slab test-terminal-app test-smoke unit format tidy shell clean ci
...
help:
	@printf '%s\n' \
		...
		'  make gui GUI_PANEL_VISIBLE=ON TERMINAL_WINDOW_CHROME=ON TERMINAL_WINDOW_INTERACTION=ON DESKTOP_BAR_DEBUG_ACTIONS=ON DESKTOP_DEBUG_DUMMY_APP=ON' \
		'                 Debug-only multi-app desktop path with a dummy app window' \
		'  make profile-gui' \
		'                 Boot GUI with profiling, scripted input, and serial log capture' \
		'  make profile-window-interaction' \
		'                 Boot scripted runtime window interaction profiling and serial log capture' \
...
profile-window-interaction:
	$(MAKE) _docker-iso GUI_PANEL_VISIBLE=ON TERMINAL_WINDOW_CHROME=ON TERMINAL_WINDOW_INTERACTION=ON DESKTOP_BAR_DEBUG_ACTIONS=ON DESKTOP_DEBUG_DUMMY_APP=ON DISPLAY_PROFILING=ON WINDOW_INTERACTION_PROFILE=ON
	$(SMOKE_WINDOW_INTERACTION_PROFILE) "$(ISO_IMAGE)" "$(WINDOW_INTERACTION_PROFILE_LOG)"
...
_docker-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-exception-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _exception-iso EXCEPTION_SMOKE=$(EXCEPTION_SMOKE) GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-timer-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _timer-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-paging-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _paging-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-heap-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _heap-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-slab-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _slab-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-terminal-app-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _terminal-app-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DESKTOP_DEBUG_DUMMY_APP=$(DESKTOP_DEBUG_DUMMY_APP) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)

_docker-smoke-isos: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _smoke-isos EXCEPTION_SMOKE=$(EXCEPTION_SMOKE) GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DESKTOP_BAR_DEBUG_ACTIONS=$(DESKTOP_BAR_DEBUG_ACTIONS) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT) WINDOW_INTERACTION_PROFILE=$(WINDOW_INTERACTION_PROFILE)
