...
_docker-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)
...
_docker-timer-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _timer-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-paging-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _paging-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-heap-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _heap-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-slab-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _slab-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-terminal-app-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _terminal-app-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) TERMINAL_WINDOW_CHROME=$(TERMINAL_WINDOW_CHROME) TERMINAL_WINDOW_INTERACTION=$(TERMINAL_WINDOW_INTERACTION) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)
