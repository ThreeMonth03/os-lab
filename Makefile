...
SMOKE_BUILD_ENV = BUILD_DIR=$(BUILD_DIR) CMAKE=$(CMAKE) GENERATOR=$(GENERATOR) TOOLCHAIN_FILE=$(TOOLCHAIN_FILE) GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)
...
_docker-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-exception-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _exception-iso EXCEPTION_SMOKE=$(EXCEPTION_SMOKE) GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-timer-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _timer-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-paging-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _paging-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)

_docker-heap-iso: _docker-image
	$(DOCKER_RUN_ENV) $(DOCKER_COMPOSE) run --rm builder make _heap-iso GUI_PANEL_VISIBLE=$(GUI_PANEL_VISIBLE) DISPLAY_PROFILING=$(DISPLAY_PROFILING) DISPLAY_PROFILE_SCRIPT=$(DISPLAY_PROFILE_SCRIPT)
