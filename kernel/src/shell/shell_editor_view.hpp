...
class EditorView {
  public:
    ...
    void redraw_change(const LineEditor& line, bool caps_lock, EditorEditKind edit,
    ...
    void redraw_history_result(HistoryResult result, StringView command, LineEditor& line,
                               bool caps_lock);
  ...
  private:
    ...
    void draw_text_range(StringView text, const EditorViewLayout& layout, size_t start,
                         size_t end) const;
