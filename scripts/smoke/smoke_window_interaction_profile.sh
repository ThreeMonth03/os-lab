...
smoke_run_qemu_capture "${image_path}" "${log_file}" 60
...
smoke_expect "${log_file}" "os-lab display profile: command=window-rapid-drag-dummy"
...
smoke_expect "${log_file}" "os-lab display profile: command=window-rapid-drag-terminal"
...
smoke_expect "${log_file}" "os-lab display profile: command=window-rapid-resize-dummy"
...
smoke_expect "${log_file}" "os-lab display profile: command=window-rapid-resize-terminal"
