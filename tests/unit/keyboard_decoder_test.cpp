...
kernel::input::keyboard::KeyEvent expect_key(kernel::input::keyboard::KeyboardDecoder & decoder,
...
void expect_no_key(kernel::input::keyboard::KeyboardDecoder & decoder, uint8_t raw_scancode)
{
    kernel::input::keyboard::KeyEvent event;
    EXPECT_FALSE(decoder.decode(raw_scancode, event));
}

kernel::input::keyboard::KeyEvent expect_extended_key(kernel::input::keyboard::KeyboardDecoder & decoder,
                                                      uint8_t scancode)
{
...
void expect_character_key(kernel::input::keyboard::KeyboardDecoder & decoder, uint8_t scancode, char expected)
{
    const kernel::input::keyboard::KeyEvent event = expect_key(decoder, scancode);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Character);
...
{
    kernel::input::keyboard::KeyboardDecoder decoder;

    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x1e);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Character);
    ...
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Shift);
...
TEST(KeyboardDecoderTest, DecodesRightShiftUppercaseAndRelease)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x36);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Shift);
    EXPECT_TRUE(event.shift);
    EXPECT_TRUE(event.pressed);
...
TEST(KeyboardDecoderTest, DecodesCapsLockWithShiftXorBehavior)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x3a);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::CapsLock);
...
TEST(KeyboardDecoderTest, TracksControlAndAltState)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x1d);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Control);
    ...
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Alt);
...
TEST(KeyboardDecoderTest, DecodesExtendedNavigationKeys)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_extended_key(decoder, 0x4b);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::LeftArrow);
    EXPECT_TRUE(event.extended);
    EXPECT_TRUE(event.pressed);

    event = expect_extended_key(decoder, 0x4d);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::RightArrow);
    EXPECT_TRUE(event.extended);

    event = expect_extended_key(decoder, 0x48);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::UpArrow);
    EXPECT_TRUE(event.extended);

    event = expect_extended_key(decoder, 0x50);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::DownArrow);
    EXPECT_TRUE(event.extended);

    event = expect_extended_key(decoder, 0x53);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Delete);
    EXPECT_TRUE(event.extended);
}
...
TEST(KeyboardDecoderTest, DoesNotEmitCharactersForKeyRelease)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x2a);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Shift);
    EXPECT_TRUE(event.pressed);
...
TEST(KeyboardDecoderTest, DecodesTabPressOnly)
{
    ...
    kernel::input::keyboard::KeyEvent event = expect_key(decoder, 0x0f);
    EXPECT_EQ(event.key, kernel::input::keyboard::Key::Tab);
    EXPECT_TRUE(event.pressed);
    EXPECT_EQ(event.character, '\0');
